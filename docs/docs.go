...
const docTemplate = `{
  ...
  "paths": {
    ...
    "/api/admin/audit": { "get": { "summary": "List moderation/admin audit events", "tags": ["Admin"], "security": [{ "BearerAuth": [] }], "parameters": [{ "name": "page", "in": "query", "type": "integer" }, { "name": "limit", "in": "query", "type": "integer" }], "responses": { "200": { "description": "Audit events", "schema": { "type": "array", "items": { "$ref": "#/definitions/AuditEvent" } } }, "403": { "description": "Forbidden" } } } },
  ...
  "definitions": {
    ...
    "RoleRequest": { "type": "object", "properties": { "role": { "type": "string", "example": "moderator" } } },
    ...
    "AuditEvent": { "type": "object", "properties": { "id": { "type": "integer" }, "actorId": { "type": "integer" }, "actorRole": { "type": "string" }, "action": { "type": "string" }, "targetType": { "type": "string" }, "targetId": { "type": "integer" }, "details": { "type": "string" }, "ip": { "type": "string" }, "userAgent": { "type": "string" }, "createdAt": { "type": "string", "format": "date-time" } } },
